...
from AstroNeuDL.data_generator.data_augmentation import data_augmentation
...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    image, mask = data_augmentation(image, mask, RCNNConfig.data_gen_args, os.path.join(os.getcwd(), "RCNN_augmentations/"))
...
class MaskRCNN():
    ...
    def set_trainable(self, layer_regex, keras_model=None, indent=0, verbose=1):
        ...
        for layer in layers:
            ...
            if layer.__class__.__name__ == 'Model':
                logging.info("In model: %s" % layer.name)
                self.set_trainable(
    ...
    def set_log_dir(self, model_path=None):
        ...
        # Path to save after each epoch. Include placeholders that get filled by Keras.
        #checkpoint_filepath = (path + "/logs" + "/pretrained_weights_" + datasetname + ".hdf5")
